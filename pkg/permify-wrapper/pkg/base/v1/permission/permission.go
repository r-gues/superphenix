...
const (
	...
	ProjectDBaaSRead        = "ProjectDBaaSRead"
	ProjectDBaaSCredentials = "ProjectDBaaSCredentials"
	ProjectDBaaSWrite       = "ProjectDBaaSWrite"
...
var PermissionsEntityMap = map[string]string{
	...
	ProjectDBaaSRead:        entity.Project,
	ProjectDBaaSCredentials: entity.Project,
	ProjectDBaaSWrite:       entity.Project,
